...
public class Hand extends CardList {
	 ...
	 *            Who play this hand
	 * @param cards
	 *            A list of cards in this hand object
	 */
	...
	/**
	 * return the top card in a hand this method will be overridden in all
	 * subclasses.
	 * 
	 ...
	 * 
	 * @param hand
	 *            Which hand to compare with
	 * @return a boolean value, true if other hand can beat this hand, false if
	 *         other hand cannot beat this hand
	 */
	public boolean beats(Hand hand) {// make sure that these two hands are all
										// valid hands
		...
		if (defendorType == attackerType) {// same card type, compare topcard
			...
			BigTwoCard defendorTopCard = new BigTwoCard(defendorHandList[defendorType].getTopCard().getSuit(),
					defendorHandList[defendorType].getTopCard().getRank());
			BigTwoCard attackerTopCard = new BigTwoCard(attackerHandList[attackerType].getTopCard().getSuit(),
					attackerHandList[attackerType].getTopCard().getRank());
		...
		} else if (defendorType >= 3 && attackerType >= 3) {// five cards in a
															// hand, but not the
															// same type
	...
	/**
	 * return a the name of this hand this method will be overridden in all
	 * subclasses
	 * 
