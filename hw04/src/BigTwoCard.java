...
public class BigTwoCard extends Card {
	...
	/**
	 * compare this card and other cards according to the BigTwo game rules
	 ...
	 * 
	 * @param card which card should this card compare with 
	 * @return an integer show whether this card is larger(1) or smaller(-1) or equal(0) the specified card
	 */
