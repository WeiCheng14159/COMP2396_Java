...
public class CardGamePlayer {
	 ...
	 * @param score the specified score to be added to this player
	 */
	...
	/**
	 * Returns the list of cards played by this player. Player can select the cards to be played by specifying the indices (space-separated) of the cards via the console. 
	 * @param lastHandOnTable the last hand of cards placed on the table
