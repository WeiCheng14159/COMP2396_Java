...
public class CardList {
	...
	/**
	 * Removes the card at the specified position in this list. Shifts any subsequent cards to the left (subtracts one from their indices).
	...
	/**
	 * Removes the first occurrence of the specified card from this list, if it is present. If the list does not contain the card, it is unchanged.
	 * Returns true if this list contained the specified card (or equivalently, if this list changed as a result of the call).
	 * @param card the card to be removed from this list, if present
	...
	/**
	 * Replaces the card at the specified position in this list with the specified card.
	 ...
	 * Equivalent to calling CardList.print(true, false);
	 */
	public void print() {
		print(true, false);
	}
	...
	/**
	 * Prints the cards in this list to the console.
	 * @param printFront a boolean value specifying whether to print the face (true) or the black (false) of the cards
	 * @param printIndex a boolean value specifying whether to print the index in front of each card
	 */
