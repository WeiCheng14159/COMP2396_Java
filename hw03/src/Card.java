...
public class Card implements Comparable<Card> {
	 ...
	 * @return an int value between 0 and 3 representing the suit of a card:<p>
	 *            0 = Diamond, 1 = Club, 2 = Heart, 3 = Spade
	 */
	public int getSuit() {
		return suit;
	 ...
	 * @return an int value between 0 and 12 representing the rank of a card:<p>
	 *            0 = 'A', 1 = '2', 2 = '3', ..., 8 = '9', 9 = '0', 10 = 'J', 11 = 'Q', 12 = 'K'
	 */
	public int getRank() {
		return rank;
	 ...
	 * @return true if this card is the same as the argument; false otherwise
	 */
